...
import com.company.statisticsprojectrc.web.importer.fileuploaddialog.ExtFileUploadDialog;
...
public class ImportScenarioBrowse extends AbstractLookup {
    ...
    @Inject
    private GroupDatasource<ImportScenario, UUID> importScenariosDs;
    ...
    public void init(Map<String, Object> params) {
        ...
        importScenariosDs.addItemChangeListener(e -> btnImport.setEnabled(e.getItem() != null));
    }
